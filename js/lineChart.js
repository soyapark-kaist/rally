$(document).ready(function() {
    ...
    function generateData() {
        ...
        sin2.push([0, -1, "아, 쫌 릴리즈"]);
        sin2.push([1, -1, "총학생회 홍보"]);
        sin2.push([8, -1, "대학원학생회 홍보"]);
        sin2.push([13, -1, "중간고사"]);
        sin2.push([14, -1, "첫 민원 정보통신팀에 발송"]);
        sin2.push([25, -1, "카대전 새버전 릴리즈"]);
        sin2.push([35, -1, "대통령 선거"]);
        sin2.push([39, -1, "랜섬웨어 사태 발발"]);
        sin2.push([46, -1, "아,쫌 점검"]);
        sin2.push([50, -1, "축제"]);
        sin2.push([55, -1, "세종관 차단기 고장"]);
